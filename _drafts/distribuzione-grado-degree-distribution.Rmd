...
A titolo di esempio, quella qui sotto è una rete non direzionata di tipo [small-world]({% post_url 2018-08-17-reti-smallworld %}), generata casualmente; l'etichetta sotto ognuno dei nodi rappresenta, appunto, il _grado_.
