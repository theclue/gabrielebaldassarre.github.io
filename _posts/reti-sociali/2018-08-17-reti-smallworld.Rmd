...
In queste reti la [distribuzione del grado]({% post_url generated/2018-07-02-importanza-individui-rete-centralita %}) (_degree distribution_) è, piuttosto, assimilabile a una [legge di potenza]({% post_url 2018-08-12-legge-potenza-powerlaw %}). Modelli più recenti di descrizione delle reti, come il modello [Barabási–Albert](https://en.wikipedia.org/wiki/Barabási–Albert_model) tengono conto di questo comportamento asimmetrico dei nodi.
